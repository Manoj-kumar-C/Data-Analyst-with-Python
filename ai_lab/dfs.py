...
if __name__ == '__main__':
    ...
    while (not found and not len(stack) == 0):
        ...
        if blankIndex != 0 and blankIndex != 3 and blankIndex != 6 and not found:
        ...
        if blankIndex != 6 and blankIndex != 7 and blankIndex != 8 and not found:
        ...
        if blankIndex != 2 and blankIndex != 5 and blankIndex != 8 and not found:
